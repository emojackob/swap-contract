...
var ChainId;
(function (ChainId) {
  ChainId[ChainId["MAINNET"] = 627] = "MAINNET";
...
var FACTORY_ADDRESS = '0xA5F093F5fBbec08dd54C21056CD1034Dc86B8fdc';
...
var INIT_CODE_HASH = '0x0eb6400693b0e38004d23fd178304efdddc3c3ebf0866b6312a49e03c5297167';
 ...
 */
Currency.HEC = /*#__PURE__*/new Currency(18, 'HEC', 'HEC');
var HEC = Currency.HEC;
...
var WHEC = (_WHEC = {}, _WHEC[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0xB7a8CB0293165eB3F06d99b17E9d7d8d9DeF8CbD', 18, 'WHEC', 'Wrapped HEC', 'https://www.binance.org'), _WHEC[ChainId.TESTNET] = /*#__PURE__*/new Token(ChainId.TESTNET, '0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd', 18, 'WBNB', 'Wrapped BNB', 'https://www.binance.org'), _WHEC);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === HEC && pairs[0].involvesToken(WHEC[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === HEC && pairs[pairs.length - 1].involvesToken(WHEC[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
    var path = [input instanceof Token ? input : WHEC[pairs[0].chainId]];
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === HEC ? CurrencyAmount.ether(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === HEC ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var etherIn = trade.inputAmount.currency === HEC;
    var etherOut = trade.outputAmount.currency === HEC;
...
export { ChainId, Currency, CurrencyAmount, FACTORY_ADDRESS, FACTORY_ADDRESS_MAP, Fetcher, Fraction, HEC, INIT_CODE_HASH, INIT_CODE_HASH_MAP, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WHEC, currencyEquals, inputOutputComparator, tradeComparator };
